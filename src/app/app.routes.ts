...
export const routes: Routes = [
  ...
  { path: 'test/PlayList-minCard', loadComponent() {
      return import('./components/cards/play-list-min-card/play-list-min-card.component').then(m => m.PlayListMinCardComponent);
    }
  },
